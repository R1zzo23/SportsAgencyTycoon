...
namespace SportsAgencyTycoon
{
    public class SoccerPlayer : Player
    {
        ...
        public SoccerPlayer(Random rnd, int id, Sports sport, FirstName firstName, LastName lastName, int skillLevel, int age, Months birthMonth, int birthWeek, Position position)
