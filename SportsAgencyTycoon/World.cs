...
namespace SportsAgencyTycoon
{
    public class World
    {
        ...
        public void CreateBasketballPlayers(Random rnd)
        {
            ...
            {
                NBA.TeamList[i].Roster.Add(new BasketballPlayer(i * 10, Sports.Basketball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.PointGuard));
                NBA.TeamList[i].Roster.Add(new BasketballPlayer(i * 10 + 1, Sports.Basketball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.PointGuard));
                NBA.TeamList[i].Roster.Add(new BasketballPlayer(i * 10 + 2, Sports.Basketball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.ShootingGuard));
                NBA.TeamList[i].Roster.Add(new BasketballPlayer(i * 10 + 3, Sports.Basketball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.ShootingGuard));
                NBA.TeamList[i].Roster.Add(new BasketballPlayer(i * 10 + 4, Sports.Basketball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.SmallForward));
                NBA.TeamList[i].Roster.Add(new BasketballPlayer(i * 10 + 5, Sports.Basketball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.SmallForward));
                NBA.TeamList[i].Roster.Add(new BasketballPlayer(i * 10 + 6, Sports.Basketball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.PowerForward));
                NBA.TeamList[i].Roster.Add(new BasketballPlayer(i * 10 + 7, Sports.Basketball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.PowerForward));
                NBA.TeamList[i].Roster.Add(new BasketballPlayer(i * 10 + 8, Sports.Basketball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Center));
                NBA.TeamList[i].Roster.Add(new BasketballPlayer(i * 10 + 9, Sports.Basketball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Center));
            }
        }
        public void CreateFootballPlayers(Random rnd)
        {
            ...
            {
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Quarterback));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 1, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Quarterback));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 2, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Runningback));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 3, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Runningback));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 4, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Fullback));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 5, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Fullback));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 6, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.WideReceiver));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 7, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.WideReceiver));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 8, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.TightEnd));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 9, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.TightEnd));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 10, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Center));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 11, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Center));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 12, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Guard));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 13, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Guard));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 14, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Tackle));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 15, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Tackle));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 16, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.DefensiveEnd));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 17, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.DefensiveEnd));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 18, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.DefensiveEnd));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 19, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.DefensiveTackle));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 20, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.DefensiveTackle));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 21, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.DefensiveTackle));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 22, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Linebacker));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 23, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Linebacker));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 24, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Linebacker));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 25, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Linebacker));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 26, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Cornerback));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 27, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Cornerback));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 28, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Cornerback));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 29, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Cornerback));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 30, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.StrongSafety));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 31, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.StrongSafety));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 32, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.FreeSafety));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 33, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.FreeSafety));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 34, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Kicker));
                NFL.TeamList[i].Roster.Add(new FootballPlayer(i * 36 + 35, Sports.Football, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(21, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Punter));
            }
        }
        public void CreateHockeyPlayers(Random rnd)
        {
            ...
            {
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Goalie));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 1, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Goalie));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 2, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Defenseman));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 3, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Defenseman));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 4, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Defenseman));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 5, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Defenseman));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 6, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Defenseman));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 7, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Defenseman));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 8, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Winger));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 9, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Winger));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 10, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Winger));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 11, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Winger));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 12, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Winger));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 13, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Winger));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 14, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Winger));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 15, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Winger));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 16, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Center));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 17, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Center));
                NHL.TeamList[i].Roster.Add(new HockeyPlayer(i * 19 + 18, Sports.Hockey, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 38), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Center));
            }
        }
        public void CreateBaseballPlayers(Random rnd)
        {
            ...
            {
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Catcher));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 1, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Catcher));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 2, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.FirstBase));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 3, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.FirstBase));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 4, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.SecondBase));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 5, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.SecondBase));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 6, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.ThirdBase));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 7, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.ThirdBase));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 8, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Shortstop));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 9, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Shortstop));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 10, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Outfield));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 11, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Outfield));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 12, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Outfield));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 13, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Outfield));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 14, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.StartingPitcher));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 15, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.StartingPitcher));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 16, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.StartingPitcher));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 17, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.StartingPitcher));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 18, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.ReliefPitcher));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 19, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.ReliefPitcher));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 20, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.ReliefPitcher));
                MLB.TeamList[i].Roster.Add(new BaseballPlayer(i * 22 + 21, Sports.Baseball, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(18, 37), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.ReliefPitcher));
            }
        }
        public void CreateSoccerPlayers(Random rnd)
        {
            ...
            {
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Keeper));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 1, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Keeper));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 2, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Defender));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 3, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Defender));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 4, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Defender));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 5, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Defender));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 6, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Defender));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 7, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Midfielder));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 8, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Midfielder));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 9, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Midfielder));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 10, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Midfielder));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 11, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Midfielder));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 12, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Forward));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 13, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Forward));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 14, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Forward));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 15, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Forward));
                MLS.TeamList[i].Roster.Add(new SoccerPlayer(i * 17 + 16, Sports.Soccer, randomFirstName(rnd), randomLastName(rnd), rnd.Next(25, 76), rnd.Next(16, 33), (Months)rnd.Next(0, 12), rnd.Next(1, 6), Position.Forward));
            }
        }
